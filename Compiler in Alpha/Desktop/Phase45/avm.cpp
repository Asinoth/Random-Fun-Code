...
void ReadBinary()
{
    ...
    if (m != 1234)
    {
        std::cout << "gamw to xristo sou" << std::endl;
    }
    else
    {
        std::cout << "grats malaka" << std::endl;
    }
    ...
    for (int i = 0; i < codeSize; ++i)
    {
        ...
        /*f.read((char *)&t.arg1.val, sizeof(unsigned));
        f.read((char *)&t.arg1.type, sizeof(t.arg1.type));

        f.read((char *)&t.arg2.val, sizeof(unsigned));
        f.read((char *)&t.arg2.type, sizeof(t.arg2.type));
...
int main()
{
    ...
    ReadBinary();
    InstructionPrint();
	for(executionFinished=false; !executionFinished;) execute_cycle();
